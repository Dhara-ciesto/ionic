    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <a href="{{route('franchise.create')}}" class="btn btn-primary float-end">{{__('Add franchise')}}</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table mb-0" id="user_table" data-unique-id="id" data-toggle="table" data-ajax="ajaxRequest" data-side-pagination="server" data-pagination="true" data-total-field="count" data-data-field="items" data-show-columns="true" data-show-toggle="false" data-filter-control="true" data-show-columns-toggle-all="true">
                        <thead>
                            <tr>
                                ...
                                <th data-field="franchise_code" data-filter-control="select" data-sortable="true">Franchise Code</th>
                                <th data-field="franchise_name" data-filter-control="input" data-sortable="true">Franchise Name</th>
                                <th data-field="phone_no" data-filter-control="input" data-sortable="true">Phone No</th>
                                <th data-field="mobile_no" data-filter-control="input" data-sortable="true">Mobile No</th>
                                <th data-field="city.name" data-filter-control="input" data-sortable="true">City</th>
                                <th data-field="area.name" data-filter-control="input" data-sortable="true">Area</th>
...
<script>
        ...
        columns: [{}, {}, {}, {}, {}, {}, {}, {}, {}
            ...
            , {
                ...
                , formatter: function(value, row, index) {
                    let url = "{{route('franchise.edit', ['id' => ':queryId'])}}";
    ...
    function ajaxRequest(params) {
        var url = "{{ route('franchise.server_side') }}"
