...
@slot('title') Add Franchise @endslot
@endcomponent
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('franchise.store')}}">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input name="franchise_code" id="franchise_code" type="text" value="{{old('franchise_code')}}" class="form-control" placeholder="Franchise Code">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input name="franchise_name" id="franchise_name" type="text" value="{{old('franchise_name')}}" class="form-control" placeholder="Franchise Name">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input name="phone_no" id="phone_no" type="text" value="{{old('phone_no')}}" class="form-control" placeholder="Phone No">
                                @error('phone_no')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input name="mobile_no" id="mobile_no" type="text" value="{{old('mobile_no')}}" class="form-control" placeholder="Mobile No">
                                @error('mobile_no')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input name="pincode" id="pincode" type="text" value="{{old('pincode')}}" class="form-control" placeholder="pincode">
                                @error('pincode')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="address" id="address" aria-label="With textarea">{{old('address')}}</textarea>
                                @error('address')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="{{route('franchise.index')}}" class="btn btn-secondary waves-effect waves-light">Cancel</a>
                    </div>
                </form>
...
<script>
    $(document).ready(function() {
        ...
        console.log('area id', "{{old('area_id')}}");
    });
                    ...
                    if (response.status) {
                        ...
                        $.each(response.data, function(key, value) {
                            ...
                            $('select[name="area_id"]').append(`<option value="${value.id}" ${(() => {if(value.id == "{{old('area_id')}}") {
                                return `selected`
                            }else {return 'asdf'}})()} >${value.name}</option>`);
