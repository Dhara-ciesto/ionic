...
@section('title') Kitchen @endsection

@section('content')
@component('components.breadcrumb')
@slot('li_1') Dashboard @endslot
@slot('title') Kitchen @endslot
@endcomponent
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <a href="{{route('kitchen.create')}}" class="btn btn-primary float-end">{{__('Add kitchen')}}</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table mb-0" id="user_table" data-unique-id="id" data-toggle="table" data-ajax="ajaxRequest" data-side-pagination="server" data-pagination="true" data-total-field="count" data-data-field="items" data-show-columns="true" data-show-toggle="false" data-filter-control="true" data-show-columns-toggle-all="true">
                        <thead>
                            <tr>
                                ...
                                <th data-field="name" data-filter-control="select" data-sortable="true">Item Name</th>
                                <th data-field="price" data-filter-control="input" data-sortable="true">Price</th>
                                <th data-field="status" data-filter-control="select" data-sortable="true">Select</th>
                            </tr>
                        </thead>
                        <tbody>
...
<script>
        ...
        columns: [{}, {}, {}, {}
            , {
                ...
                , formatter: function(value, row, index) {
                    let url = "{{route('kitchen.edit', ['id' => ':queryId'])}}";
    ...
    function ajaxRequest(params) {
        var url = "{{ route('kitchen.server_side') }}"
    ...
    function remove(id, index) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "{{route('kitchen.destroy', ['id' => ':queryId'])}}";
