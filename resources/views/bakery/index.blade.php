...
@section('title') Bakery @endsection

@section('content')
@component('components.breadcrumb')
@slot('li_1') Dashboard @endslot
@slot('title') Bakery @endslot
@endcomponent
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <a href="{{route('bakery.create')}}" class="btn btn-primary float-end">{{__('Add bakery')}}</a>
            </div>
            <div class="card-body">
...
<script>
        ...
        columns: [{}, {}, {}, {}
            , {
                ...
                , formatter: function(value, row, index) {
                    let url = "{{route('bakery.edit', ['id' => ':queryId'])}}";
    ...
    function ajaxRequest(params) {
        var url = "{{ route('bakery.server_side') }}"
    ...
    function remove(id, index) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "{{route('bakery.destroy', ['id' => ':queryId'])}}";
