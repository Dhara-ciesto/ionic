        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('unit.create') }}" class="btn btn-outline-danger float-end">{{ __('Add Unit') }}</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table mb-0" id="unit_table" data-unique-id="id" data-toggle="table"
                            ...
                            <div id="filters" class="row bootstrap-table-filter-control">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control bootstrap-table-filter-control-name" data-placeholder="Select Unit Name">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="name" data-filter-control="select" data-sortable="true">Unit Name</th>
                                </tr>
                            </thead>
                            <tbody>
...
@section('script')
    ...
    <script>
        ...
        $table.bootstrapTable({
            columns: [{}, {}, {
                ...
                formatter: function(value, row, index) {
                    let url = "{{ route('unit.edit', ['id' => ':queryId']) }}";
        ...
        function ajaxRequest(params) {
            var url = "{{ route('unit.server_side') }}"
        ...
        function remove(id, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "{{ route('unit.destroy', ['id' => ':queryId']) }}";
