    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <a href="{{route('city.create')}}" class="btn btn-primary float-end">{{__('Add city')}}</a>
            </div>
            <div class="card-body">
...
<script>
        ...
        columns: [{}, {}, {}
            , {
                ...
                , formatter: function(value, row, index) {
                    let url = "{{route('city.edit', ['id' => ':queryId'])}}";
    ...
    function ajaxRequest(params) {
        var url = "{{ route('city.server_side') }}"
    ...
    function remove(id, index) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "{{route('city.destroy', ['id' => ':queryId'])}}";
