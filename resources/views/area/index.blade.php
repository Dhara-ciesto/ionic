    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <a href="{{route('area.create')}}" class="btn btn-primary float-end">{{__('Add area')}}</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table mb-0" id="user_table"  data-unique-id="id" data-toggle="table" data-ajax="ajaxRequest" data-side-pagination="server" data-pagination="true" data-total-field="count" data-data-field="items" data-show-columns="true" data-show-toggle="false" data-filter-control="true" data-show-columns-toggle-all="true" >
                        <thead>
                            <tr>
                                ...
                                <th data-field="city.name" data-filter-control="select" data-sortable="true">City</th>
...
<script>
        ...
        columns: [{}, {}, {}, {}
            , {
                ...
                , formatter: function(value, row, index) {
                    let url = "{{route('area.edit', ['id' => ':queryId'])}}";
    ...
    function ajaxRequest(params) {
        var url = "{{ route('area.server_side') }}"
    ...
    function remove(id, index) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "{{route('area.destroy', ['id' => ':queryId'])}}";
