                        ...
                        <table class="table mb-0" id="user_table" data-unique-id="id" data-toggle="table"
                            ...
                            <div id="filters" class="row bootstrap-table-filter-control">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control bootstrap-table-filter-control-username"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="username" data-filter-control="select" data-sortable="true">Business
                                        Name</th>
                                    <th data-field="whatsapp_no" data-filter-control="select" data-sortable="true">Whatsapp
                                        No</th>
        ...
        $table.bootstrapTable({
            ...
            columns: [{}, {}, {}, {}, {
                ...
                formatter: function(value, row, index) {
                    ...
                    let action = `<button type="button" onClick="changeStatus(${row.id}, ${index}, '${new_status}')" class="btn btn-sm `+color+`">`+new_status+`</button>&nbsp;<button onClick="remove(${row.id}, ${index})" class="btn btn-sm btn-danger">Delete</button>
